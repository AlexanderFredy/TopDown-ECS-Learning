...
public class RewardedAdsButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, IUnityAdsListener
{
    ...
    [SerializeField]  MyIAPManager m_manager;
    ...
    public void OnUnityAdsShowStart(string adUnitId) { print("new movie started"); ; }
    public void OnUnityAdsShowClick(string adUnitId) { print("new movie clicked"); }
